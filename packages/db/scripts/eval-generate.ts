...
// Run: pnpm --filter @goooose/db exec tsx scripts/eval-generate.ts
...
import { buildVideoAnalysisPrompt, buildHumanSopPrompt, buildHottestSopPrompt } from "@goooose/prompts/clerk";
import { generateChannelBible } from "@goooose/domain/services/poet/bible";
import { analyzeViralTrigger, generateIdeas } from "@goooose/domain/services/muse";
import { analyzeTopic } from "@goooose/domain/services/poet/topic-analyzer";
import { writeScript, writeScriptShort } from "@goooose/domain/services/poet/script-writer";
import { humanizeChinese } from "@goooose/domain/services/poet/humanizer";
