...
- SOURCE does NOT support it → make the smallest fix: replace the exact figure/name with a general phrasing, drop the false precision, or mark it ${tag}. A quoted line not found in the SOURCE: remove the quotation/attribution or mark it ${tag}. Never leave an unsupported specific stated as fact.
